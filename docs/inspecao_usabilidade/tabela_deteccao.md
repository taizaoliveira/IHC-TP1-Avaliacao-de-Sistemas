...
|  7 | Login através de "Entrar com email e senha": Mensagens de erro em inglês e a falta de padrão na exibição dos erros quebram a consistência de idioma e design da interface em português                                                                                 | Consistência e padrões (H4)                                        | 4 | 01:00 |
...
| 13 | Interface "Dados Pessoais": Os usuários são enganados ao tentarem preencher dados nas caixas brancas, quando deveriam clicar em "editar"                                                                                                                                  | Consistência e padrões (H4)                                        | 3 | 01:00 |
| 14 | Interface "Dados Pessoais": Não há um atalho específico para preencher rapidamente as informações sem precisar clicar em "editar"  | Flexibilidade e eficiência de uso (H7)                             | 2 | 01:00 |
| 15 | Interface "Dados Pessoais": O sistema não fornece feedback ao clicar na caixa "Quero receber emails" do boletim informativo, informando se os emails aparecerão na caixa de entrada                                                                                    | Visibilidade do status do sistema (H1)                             | 2 | 01:00 |
| 16 | Barra de Categorias: O sistema não fornece feedback sobre para onde o usuário foi direcionado ao clicar em outra categoria                  | Visibilidade do status do sistema (H1)                             | 2 | 01:30 |
| 17 | Barra de Categorias: Não há botão para retornar ao menu principal                                                                           | Controle e liberdade do usuário (H3)                               | 2 | 01:30 |
| 18 | Barra de Categorias: Ao clicar em "compre por categoria", os hyperlinks levam a outras páginas, mas o modo como a aba aparece e desaparece é irritante e ineficiente                                                                                                                 | Flexibilidade e eficiência de uso (H7)                             | 2 | 01:30 |
| 19 | Barra de Categorias: Design muito ruim, não é estético nem minimalista, pois apresenta muitas informações desorganizadas | Design estético e minimalista (H8) | 3 | 01:30 |
| 20 | Visualizar páginas de livros/compra: Design de compra pouco estético e minimalista, com imagens de baixa qualidade e excesso de informações | Design estético e minimalista (H8) | 3 | 01:30 |
| 21 | Visualizar páginas de livros/páginas: Não há atalho para voltar, e, se existir, não é facilmente encontrado | Flexibilidade e eficiência de uso (H7) | 3 | 01:30 |
| 22 | Lista de categorias: não segue padrões e só pode ser acessada ao realizar uma pesquisa | Consistência e padrões (H4) | 3 | 01:30 |
| 23 | Lista de categorias: A lista de hiperlinks é desnecessária e não permite retornar às outras categorias após clicar em um deles | Flexibilidade e eficiência de uso (H7) | 3 | 01:30 |
| 24 | Lista de categorias: A lista está desorganizada, como se alguém tivesse mexido, mesmo sem intervenção do usuário, além das cores e tamanhos de letras variados | Design estética e minimalista (H8) | 3 | 01:30 |
| 25 | Lista de categorias: Não há controle ou liberdade para o usuário voltar ou acessar outras categorias à vontade | Controle e liberdade do usuário (H3) | 3 | 01:30 |
| 26 | Filtros: Poucos filtros disponíveis, com poucas opções, e alguns são desativados ao ajustar outros | Flexibilidade e eficiência de uso (H7) | 3 | 01:30 |
| 20 | Sistema: Falta de aviso claro sobre a não salvaguarda da lista de desejos após logout                                              | Ajude a reconhecer e recuperar erros (H9)                          |  4 | 01:30 |
| 17 | Sistema: A ausência de salvamento automático das listas de desejos desvia dos padrões esperados de design                         | Consistência e padrões (H4)                                        | 4 | 01:30 |
| 18 | Sistema: A falta de salvamento automático da lista de desejos força os usuários a repetir ações anteriores e reduzindo a eficiência de uso                                                                                                                         | Flexibilidade e eficiência de uso (H7)                             | 4 | 01:30 |
| 19 | Sistema: A falta de feedback sobre o salvamento da lista de desejos ou do carrinho de compras após o logout pode confundir e frustrar os usuários                                                                                                                      | Visibilidade do status do sistema (H4)                             | 4 | 01:30 |
| 20 | Sistema: A falta de controle sobre o salvamento e restauração das listas de desejos e carrinho pode limitar a liberdade do usuário, impedindo-o de manter itens na lista de desejos                                                                                 | Controle e liberdade do usuário (H3)                               | 4 | 01:30 |
| 21 | Sistema: Quando o sistema não mantém a lista de desejos ou o carrinho após o logout, o usuário precisa lembrar quais itens foram selecionados ao fazer login novamente                                                                                                     | Reconhecimento em vez de recordação (H6)                           | 4 | 01:30 |
