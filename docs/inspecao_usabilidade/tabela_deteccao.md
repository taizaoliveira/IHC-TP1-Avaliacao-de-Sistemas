...
| 27 | Lista de categorias: Não há controle ou liberdade para o usuário voltar ou acessar outras categorias à vontade | Controle e liberdade do usuário (H3) | 3 | 01:30 |
| 28 | Lista de categorias: não segue padrões e só pode ser acessada ao realizar uma pesquisa | Consistência e padrões (H4) | 3 | 01:30 |
| 29 | Lista de categorias: A lista de hiperlinks é desnecessária e não permite retornar às outras categorias após clicar em um deles | Flexibilidade e eficiência de uso (H7) | 3 | 01:30 |
| 30 | Lista de categorias: A lista está desorganizada, como se alguém tivesse mexido, mesmo sem intervenção do usuário, além das cores e tamanhos de letras variados | Design estética e minimalista (H8) | 3 | 01:30 |
...
| 32 | Lista de desejos: Falta de feedback sobre o salvamento da lista ou do carrinho de compras após o logout| Visibilidade do status do sistema (H1) | 4 | 02:00 |
| 33 | Lista de desejos: A falta de controle sobre o salvamento e restauração pode limitar a liberdade do usuário, impedindo-o de manter itens na lista de desejos | Controle e liberdade do usuário (H3) | 4 | 02:00 |
| 34 | Lista de desejos: A ausência de salvamento automático desvia dos padrões esperados de design | Consistência e padrões (H4) | 4 | 02:00 |
| 35 | Lista de desejos: Quando o sistema não mantém a lista de desejos ou o carrinho após o logout, o usuário precisa lembrar quais itens foram selecionados ao fazer login novamente | Reconhecimento em vez de recordação (H6) | 4 | 02:00 |
| 36 | Lista de desejos:: A falta de salvamento automático força os usuários a repetir ações anteriores e reduzindo a eficiência de uso | Flexibilidade e eficiência de uso (H7) | 4 | 02:00 |
| 37 | Lista de desejos: Falta de aviso claro sobre a não salvaguarda após logout | Ajude a reconhecer e recuperar erros (H9) |  4 | 02:00 |
...
| 42 | Comprar: Não há opção para voltar | Controle e liberdade do usuário (H3) | 4 | 02:00 |
| 43 | Comprar: Mesmo após adicionar meu endereço, o sistema não preenche nem calcula o frete automaticamente | Flexibilidade e eficiência de uso (H7) | 4 | 02:00 |
| 44 | Comprar: O design não é estético, com fontes, cores e tamanhos inconsistentes, prejudicando a experiência do usuário, especialmente no hiperlink "escolher mais produtos" | Design estético e minimalista (H8) | 3 | 02:00 |
| 45 | Cupom: A ausência de base para o código do cupom expõe o usuário a falhas | Prevenção de erros (H5) | 3 | 02:00 |
| 46 | Cupom: O usuário deve digitar o código do cupom sem orientações, e o sistema não informa se há cupons disponíveis. | Flexibilidade e eficiência de uso (H7) | 3 | 02:00 |
| 47 | Finalizar compra: O sistema não fornece feedback antes de chegar a esta página, nem informa o que vem a seguir | Visibilidade do status do sistema (H1) | 1 | 02:00 |
...
| 53 | Pagamento: O sistema não fornece feedback sobre o pagamento em processamento ou finalização, nem orienta sobre o que fazer a seguir | Visibilidade do status do sistema (H1) | 4 | 02:00 |
| 54 | Pagamento: O sistema não oferece uma saída de emergência para o usuário cancelar o pedido | Controle e liberdade (H3) | 4 | 02:00 |
| 55 | Pagamento: O sistema não oferece atalhos para facilitar o pagamento nem para voltar | Flexibilidade e eficiência de uso (H7) | 3 | 02:00 |
