...
|  9 | Login através de "Entrar com Facebook": O sistema não oferece alternativas de login além do Facebook, o que poderia tornar o processo mais rápido, e essa função não está funcionando                                                                                  | Flexibilidade eficiência de uso (H7)                               | 3 | 01:00 |
| 10 | Interface "Minha Conta": Há muitas informações, e todas estão desorganizadas                                                       | Design estético e minimalista (H8)                                 | 4 | 01:00 |
| 11 | Interface "Dados Pessoais": Os usuários são enganados ao tentarem preencher dados nas caixas brancas, quando deveriam clicar em "editar"                                                                                                                                  | Consistência e padrões (H4)                                        | 3 | 01:00 |
| 12 | Interface "Dados Pessoais": Não há um atalho específico para preencher rapidamente as informações sem precisar clicar em "editar"  | Flexibilidade e eficiência de uso (H7)                             | 2 | 01:00 |
